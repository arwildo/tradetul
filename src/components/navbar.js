...
export default function(props) {
  ...
  if (location === "/explanation") {
    navbarContent = <>
      ...
      <Link to="/spot" className="mt-1 group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-full hover:bg-gray-800 hover:text-blue-300">
        <svg className="mr-4 h-6 w-6 " stroke="currentColor" fill="none" viewBox="0 0 24 24">
	        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 6l7 7 7-7m-7 7V3m0 14V3" />
        </svg>
        <span className="invisible sm:visible">
         Spot
        </span>
    ...
    navbarContent = <>
      ...
      <Link to="/spot" className="mt-1 group flex items-center px-2 py-2 text-sm leading-6 font-semibold rounded-full bg-gray-800 text-blue-300">
        <svg className="mr-4 h-6 w-6 " stroke="currentColor" fill="none" viewBox="0 0 24 24">
	        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 6l7 7 7-7m-7 7V3m0 14V3" />
        </svg>
        <span className="invisible sm:visible">
